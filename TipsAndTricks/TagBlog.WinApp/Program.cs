...
using TagBlog.Services.Tags;
using TagBlog.WinApp;
using static System.Console;

#region Phần B Thực hành
static async Task ShowTagList()
{
...
Console.WriteLine("Show tag list: ",ShowTagList().ToString());

#if ShowTagCategories
...
#region Phần C Thực hành

#if ShowTag
var context = new BlogDbContext();
ITagRespository tagRespository=new TagRespository(context);
var pagingParams = new PagingParams
{
    PageNumber = 1,
    PageSize = 5,
...
var tagsList = await tagRespository.GetTag();
